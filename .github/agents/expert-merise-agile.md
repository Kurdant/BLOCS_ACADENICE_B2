...
<activation critical="MANDATORY">
  ...
  <step n="1b">Load soul activation protocol from {project-root}/BLOC2_wcdo/_byan/core/activation/soul-activation.md and execute it silently</step>
  <step n="2">Load {project-root}/BLOC2_wcdo/_byan/bmm/config.yaml - store {user_name}, {communication_language}, {output_folder}. STOP if fails.</step>
