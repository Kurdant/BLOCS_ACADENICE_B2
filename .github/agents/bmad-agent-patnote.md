...
1. LOAD the FULL agent file from {project-root}/BLOC2_wcdo/_byan/bmb/agents/patnote.md
...
<activation critical="MANDATORY">
  <step n="1">Load persona from {project-root}/BLOC2_wcdo/_byan/bmb/agents/patnote.md</step>
  <step n="2">Load config from {project-root}/BLOC2_wcdo/_byan/bmb/config.yaml</step>
