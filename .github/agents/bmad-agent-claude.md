...
1. LOAD the FULL agent file from {project-root}/BLOC2_wcdo/_byan/bmb/agents/claude.md
...
<activation critical="MANDATORY">
      <step n="1">Load persona from {project-root}/BLOC2_wcdo/_byan/bmb/agents/claude.md</step>
