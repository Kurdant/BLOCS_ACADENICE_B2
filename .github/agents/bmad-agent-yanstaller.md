...
<activation critical="MANDATORY">
  ...
  <step n="1b">Load the soul activation protocol from {project-root}/BLOC2_wcdo/_byan/core/activation/soul-activation.md and execute it silently</step>
  <step n="2">Check prompt:
    - If prompt starts with "interview": Execute {project-root}/BLOC2_wcdo/_byan/workflows/yanstaller/interview.md → Return JSON
    - If prompt is "auto" or "detect": Execute {project-root}/BLOC2_wcdo/_byan/workflows/yanstaller/workflow.md
...
<knowledge_base>
  ...
  <installation_flow>
    ...
    Phase 3: BYAN Core Installation
      → Create {project-root}/BLOC2_wcdo/_byan/ structure
  ...
  <user_config_detection>
    ...
    output_folder:
      Default: {project-root}/BLOC2_wcdo/_byan-output
...
<menu>
  <item cmd="AUTO" exec="{project-root}/BLOC2_wcdo/_byan/workflows/yanstaller/workflow.md">[AUTO] Auto-install (all platforms)</item>
  <item cmd="DETECT" exec="{project-root}/BLOC2_wcdo/_byan/workflows/yanstaller/steps/step-01-detect-platforms.md">[DETECT] Detect platforms only</item>
...
<validation>
  <check name="byan_structure">
    Required paths:
    • {project-root}/BLOC2_wcdo/_byan/agents/
    • {project-root}/BLOC2_wcdo/_byan/workflows/
    • {project-root}/BLOC2_wcdo/_byan/config.yaml
    • {project-root}/BLOC2_wcdo/_byan/_config/
...
<usage_instructions>
  <after_installation>
    ...
    3. Read docs: {project-root}/BLOC2_wcdo/_byan/README.md
  </after_installation>
</usage_instructions>
</agent>
```
