...
1. LOAD the FULL agent file from {project-root}/BLOC2_wcdo/_byan/bmb/agents/byan-test.md
2. READ its entire contents - this contains the complete agent persona, menu, and instructions
3. LOAD the soul activation protocol from {project-root}/BLOC2_wcdo/_byan/core/activation/soul-activation.md and EXECUTE it silently
...
<activation critical="MANDATORY">
  <step n="1">Load persona from {project-root}/BLOC2_wcdo/_byan/bmb/agents/byan-test.md</step>
  <step n="2">Load config from {project-root}/BLOC2_wcdo/_byan/bmb/config.yaml - store {user_name}, {communication_language}, {output_folder}</step>
